...
$sql="SELECT * FROM product_info WHERE ProID = '".$_REQUEST["ProID"]."' ORDER BY ProID DESC";
$jsonData= getJSONFromDB($sql);
$jsonData = json_decode($jsonData, true);

$sql="select * from user_info where username = (select username from product_info where proid = '".$_REQUEST["ProID"]."')";
